        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter="*" class="filter-active">electronic</li>
              <li data-filter="*" class="filter-active">furniture</li>
              <li data-filter="*" class="filter-active">food</li>
              <li data-filter="*" class="filter-active">drinks</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          foreach ($row as $prod) : ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="https://www.boladeli.id/images/artikel-kemasan-produk-detail.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?= $prod['nama'];  ?></h4>
                <p><?= $prod['kategori'];  ?></p>
                <a href="assets/img/portfolio/electronic1 (ac).jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="AC"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                <a class="btn btn-light" href="detail_produk.php?id=<?= $prod['id'] ?>" role="button">Detail</a>
              </div>
            </div>
          <?php endforeach; ?>
